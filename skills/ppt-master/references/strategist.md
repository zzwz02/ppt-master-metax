...
After selecting the layout type, the Strategist MUST check the template's `design_spec.md` for any image sizing or layout constraints and record them in the Content Outline. Template constraints override the default formulas.
